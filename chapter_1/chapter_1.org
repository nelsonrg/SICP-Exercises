...
For this one, the algorithm is highly sensitive to the initial guess
being nearly correct. For 27 it works for guesses between 2 and 4
exclusively and otherwise it blows up.
